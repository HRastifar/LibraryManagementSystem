...
Connection connection; 
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblEdition, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 90, 25));
    ...
    //This method save the change made to the book.
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        
        
        String sql = "update book set name=?,author=?,edition=?,category=?,publisher=?,publish_date=? where id=?";
        ...
        try(PreparedStatement pst = connection.prepareStatement(sql);)
        {
            ...
            pst.setString(4,combCategory.getSelectedItem().toString());
            pst.setString(5, txtPublisher.getText());
             pst.setDate(6,getDate());
            pst.setString(7,txtId.getText());
            if(pst.execute()){
                JOptionPane.showOptionDialog(null, " Edit was not applied !","Failure",JOptionPane.OK_CANCEL_OPTION,JOptionPane.INFORMATION_MESSAGE,null,null,null);
            }
                else{
                int input = JOptionPane.showOptionDialog(null, " Edit was applied !","Success",JOptionPane.OK_CANCEL_OPTION,JOptionPane.INFORMATION_MESSAGE,null,null,null);
    ...
    private void showInfo() {
            String sqlBookInfo ="select * from book where id =?";
       
       try(PreparedStatement pst = connection.prepareStatement(sqlBookInfo);){
           ...
           if(rs.next()){
                ...
                combCategory.setSelectedItem(rs.getString(4));
                txtId.setText(rs.getString(5));
                txtPublisher.setText(rs.getString(6));
                datePublishDate.setDate(rs.getDate(7));
